...
class Notepad(QMainWindow):
    def __init__(self):
        ...
        self.showMaximized()
        self.setWindowTitle('My Awesome Notepad')
    ...
    def create_menu_bar(self):
        ...
        save_af_pdf_action = QAction('save as pdf', self)
        save_af_pdf_action.triggered.connect(self.save_as_pdf)
        file_menu.addAction(save_af_pdf_action)
